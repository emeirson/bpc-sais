<div class="bg-white dark:bg-gray-800 relative overflow-hidden">
    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 py-4">
        ...
        <div
            ...
            <x-button.create href="{{ route('semesters.create') }}" name="Add semester" />
    ...
    <div class="overflow-x-auto border">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <x-table.thead :headers="['#', 'year', 'name', 'status']" />
            <tbody>
                ...
                @forelse ($semesters as $semester)
                    <tr class="border-b dark:border-gray-700">
                        ...
                        <x-table.data>
                            AY : {{ $semester->academicYear->getYear() }}
                        </x-table.data>
                        <x-table.data>
                            {{ strtoupper($semester->name) }}
                        </x-table.data>
                        <x-table.data>
                            <div>
                                {{ $semester->status }}
        ...
        <x-table.pagination>{{ $semesters->links() }} </x-table.pagination>
    </div>
</div>
</div>
