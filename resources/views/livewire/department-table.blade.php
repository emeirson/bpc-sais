<div class="bg-white dark:bg-gray-800 relative overflow-hidden">
    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 py-4">
        ...
        <div
            ...
            <x-button.create href="{{ route('departments.create') }}" name="Add department" />
    ...
    <div class="overflow-x-auto border">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <x-table.thead :headers="['#', 'code', 'name', 'college']" />
            <tbody>

                @forelse ($departments as $department)
                    <tr class="border-b dark:border-gray-700" wire:key="item-{{ $department->id }}">
                        ...
                        <td class="px-4 py-3 flex items-center justify-end">
                            <button id="dropdown-button" data-dropdown-toggle="dropdown-{{ $loop->iteration }}"
                                wire:key="item-{{ $department->id }}" data-dropdown-placement="top"
                            ...
                            <div id="dropdown-{{ $loop->iteration }}" wire:key="item-{{ $department->id }}"
                                class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
        ...
        <x-table.pagination>{{ $departments->links() }} </x-table.pagination>
    </div>
</div>
