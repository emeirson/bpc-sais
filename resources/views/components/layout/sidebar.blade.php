        ...
        <ul class="space-y-2">
            ...
            <li>
                ...
                <ul id="dropdown-pages" class="py-2 space-y-2">
                    <li>
                        <x-sidebar.link href="{{ route('colleges.index') }}">Colleges</x-sidebar.link>
                    </li>
                    <li>
                        <x-sidebar.link href="{{ route('departments.index') }}">Departments</x-sidebar.link>
                    </li>
                    <li>
                        <x-sidebar.link href="{{ route('programs.index') }}">Programs</x-sidebar.link>
                    </li>
                    <li>
                        <x-sidebar.link href="{{ route('students.index') }}">Students</x-sidebar.link>
                    </li>
                    <li>
                        <x-sidebar.link href="{{ route('courses.index') }}">Courses</x-sidebar.link>
                    </li>
                    <li>
                    ...
                    <li>
                        <x-sidebar.link href="{{ route('class-course.index') }}">Class</x-sidebar.link>
                    </li>
                </ul>
            </li>
            <li>
