                ...
                <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                    <div class="sm:col-span-2">
                        ...
                        <select name="college_id" id="college_id"
                            ...
                            @foreach ($colleges as $college)
                                <option @selected(old('college_id', $course->college_id) == $college->id) value="{{ $college->id }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="department_id" id="department_id"
                            ...
                            @foreach ($departments as $department)
                                <option @selected(old('department_id', $course->department_id) == $department->id) value="{{ $department->id }}">
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <x-form.input type='number' id="laboratory_hours" name="laboratory_hours" min="0"
                            value="{{ old('laboratory_hours', $course->laboratory_hours) }}"
