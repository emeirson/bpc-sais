                            ...
                            <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <x-form.input type='text' id="name_extension" name="name_extension"
                                        value="{{ old('name_extension', $student->name_extension) }}"
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <x-form.input type='text' id="town" name="town"
                                        value="{{ old('town', $student->town) }}" placeholder="Enter town" />
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <select name="civil_status" id="civil_status"
                                        ...
                                        <option value="single" @selected(old('civil_status', $student->civil_status) == 'single')>Single</option>
                                        <option value="married" @selected(old('civil_status', $student->civil_status) == 'married')>Married</option>
                                        <option value="widowed" @selected(old('civil_status', $student->civil_status) == 'widowed')>Widowed</option>
                                        <option value="separated" @selected(old('civil_status', $student->civil_status) == 'separated')>Separated</option>
                                        <option value="solo parent" @selected(old('civil_status', $student->civil_status) == 'solo parent')>Solo Parent</option>
                                    </select>
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <x-form.input type='text' id="citizenship" name="citizenship"
                                        value="{{ old('citizenship', $student->citizenship) }}"
                            ...
                            <div class="pl-4 grid gap-4 sm:grid-cols-4 sm:gap-6 my-8">
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <x-form.input type='text' id="father_firstname" name="father_firstname"
                                        value="{{ old('father_firstname', $student->father_firstname) }}"
                                        placeholder="Enter firstname" />
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <x-form.input type='text' id="father_middlename" name="father_middlename"
                                        value="{{ old('father_middlename', $student->father_middlename) }}"
                                        placeholder="Enter middlename" />
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <x-form.input type='text' id="father_mobile_number"
                                        ...
                                        value="{{ old('father_mobile_number', $student->father_mobile_number) }}"
                                        placeholder="Enter mobile number" />
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <select name="father_education" id="father_education"
                                        ...
                                        <option value="Elementary Graduate" @selected(old('highest_educational_attainment', $student->highest_educational_attainment) == 'Elementary Graduate')>Elementary
                                            Graduate</option>
                                        <option value="High School Graduate" @selected(old('highest_educational_attainment', $student->highest_educational_attainment) == 'High School Graduate')>High School
                                            Graduate</option>
                                        <option value="College Graduate" @selected(old('highest_educational_attainment', $student->highest_educational_attainment) == 'College Graduate')>College Graduate
                                        </option>
                                        <option value="Master's Graduate" @selected(old('highest_educational_attainment', $student->highest_educational_attainment) == "Master's Graduate")>Master's
                                            Graduate</option>
                                        <option value="Doctorate Graduate" @selected(old('highest_educational_attainment', $student->highest_educational_attainment) == 'Doctorate Graduate')>Doctorate
                                            Graduate</option>
                                    </select>
                            ...
                            <div class="pl-4 grid gap-4 sm:grid-cols-4 sm:gap-6 my-8">
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <select name="beneficiary_4ps" id="beneficiary_4ps"
                                        class='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500'>
                                        <option value="1" @selected(old('beneficiary_4ps', $student->beneficiary_4ps) == '1')>Yes</option>
                                        <option value="0" @selected(old('beneficiary_4ps', $student->beneficiary_4ps) == '0')>No</option>
                                    </select>
